...
//        {id: 22, name: 'Symeon', ores: [0, 4, 9, 12, 20], gp: 36, altitude: 39},
        {id: 25, name: 'Talemai', ores: [1, 2, 3, 7, 9, 15], gp: 42, altitude: 580},
          {id: 12, name: 'Talemai Moon 1', ores: [ 0, 1, 3, 4, 9, 12], gp: 11, altitude: 0},
          {id: 3, name: 'Talemai Moon 2', ores: [0, 2, 3, 5, 11, 13], gp: 8, altitude: 0},
          {id: 4, name: 'Talemai Moon 3', ores: [0, 1, 2, 6, 8, 14], gp: 8, altitude: 0},
