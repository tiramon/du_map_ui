...
@NgModule({
    ...
    providers: [
      ...
      {provide: 'PLANETS', useValue: [
        {id: 31, name: 'Alioth', ores: [0, 1, 2, 3, 6, 8], gp: 93, altitude: 200},
        ...
        {id: 19, name: 'Madis', ores: [0, 1, 2, 3, 7, 9], gp: 32, altitude: 750},
        ...
        {id: 28, name: 'Teoma', ores: [0, 1, 2, 3, 7, 9, 12 ], gp: 45, altitude: 700},
        {id: 21, name: 'Thades', ores: [0, 1, 2, 3, 4, 11], gp: 36, altitude: 13640},
